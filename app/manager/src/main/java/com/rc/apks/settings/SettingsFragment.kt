...
import com.rc.apks.ShizukuSettings.KEEP_START_ON_BOOT
import com.rc.apks.adb.AdbPairingTutorialActivity
import com.rc.apks.app.ThemeHelper
import com.rc.apks.app.ThemeHelper.KEY_BLACK_NIGHT_THEME
import com.rc.apks.app.ThemeHelper.KEY_USE_SYSTEM_COLOR
...
import java.util.*
import com.rc.apks.ShizukuSettings.LANGUAGE as KEY_LANGUAGE
import com.rc.apks.ShizukuSettings.NIGHT_MODE as KEY_NIGHT_MODE
...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private lateinit var pairingPreference: Preference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        pairingPreference = findPreference("pairing")!!
        ...
        // Pairing preference
        pairingPreference.setOnPreferenceClickListener {
            startActivity(Intent(context, AdbPairingTutorialActivity::class.java))
            true
        }

        // Hide pairing on devices below Android 11
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
            pairingPreference.isVisible = false
        }
